...
export const CASES: CasesMap = {
    ...
    enron: {
        ...
        script: [
            ...
            {s: 'MR. PETROCELLI (DEFENSE)', t: 'Objection. That conviction was overturned by the Supreme Court.'},
    ...
    kitzmiller: {
        ...
        script: [
            ...
            {s: 'MICHAEL BEHE', t: 'I think it would.'},
            {s: 'MR. ROTHSCHILD', t: "Let's turn to 'Of Pandas and People.' Look at page 99."},
            {s: 'MR. MUISE (DEFENSE)', t: "Objection, Dr. Behe didn't write that book."},
